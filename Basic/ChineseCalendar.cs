...
namespace CLib.Basic
{
     ...
     * 类 名 称:	ChineseCalendar
     * 机器名称:	LUMIA800
     * 命名空间:	CLib.Basic
     * 文 件 名:	ChineseCalendar
     * 创建时间:	2013/2/7 14:23:41
     * 作    者:	常伟华 Changweihua
	 * 版    权:	ChineseCalendar说明：本代码版权归常伟华所有，使用时必须带上常伟华网站地址 All Rights Reserved (C) 2013 - 2014
     * 签    名:	To be or not, it is not a problem !
     * 网    站:	http://www.cmono.net
     * 邮    箱:	changweihua@outlook.com  
     * 唯一标识:	9026141d-d453-4ca2-a51d-91a8e7f216c4  
	 *
	 * 登录用户:	Changweihua
	 * 所 属 域:	Lumia800
